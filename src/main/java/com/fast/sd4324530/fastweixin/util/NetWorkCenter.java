package com.fast.sd4324530.fastweixin.util;
...
public final class NetWorkCenter {
    ...
    public static com.fast.sd4324530.fastweixin.api.response.BaseResponse post(String url, String paramData) {
        final com.fast.sd4324530.fastweixin.api.response.BaseResponse[] response = new com.fast.sd4324530.fastweixin.api.response.BaseResponse[]{null};
        post(url, paramData, new ResponseCallback() {
            public void onResponse(int resultCode, String resultJson) {
                if (200 == resultCode) {
                    com.fast.sd4324530.fastweixin.api.response.BaseResponse r = JSONUtil.toBean(resultJson, com.fast.sd4324530.fastweixin.api.response.BaseResponse.class);
                    r.setErrmsg(resultJson);
                    response[0] = r;
                } else {//请求本身就失败了
                    response[0] = new com.fast.sd4324530.fastweixin.api.response.BaseResponse();
    ...
    public static com.fast.sd4324530.fastweixin.api.response.BaseResponse post(String url, String paramData, List<File> fileList) {
        final com.fast.sd4324530.fastweixin.api.response.BaseResponse[] response = new com.fast.sd4324530.fastweixin.api.response.BaseResponse[]{null};
    ...
    public static com.fast.sd4324530.fastweixin.api.response.BaseResponse get(String url) {
        final com.fast.sd4324530.fastweixin.api.response.BaseResponse[] response = new com.fast.sd4324530.fastweixin.api.response.BaseResponse[]{null};
