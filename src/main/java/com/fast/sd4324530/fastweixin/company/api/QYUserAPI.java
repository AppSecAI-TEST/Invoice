...
import com.fast.sd4324530.fastweixin.company.api.response.GetQYUserInfoResponse;
...
public class QYUserAPI extends QYBaseAPI {
     ...
     */
    public QYUserAPI(com.fast.sd4324530.fastweixin.company.api.config.QYAPIConfig config) {
        super(config);
    }
     ...
     * @return 创建结果
     */
    public QYResultType create(com.fast.sd4324530.fastweixin.company.api.entity.QYUser user){
        com.fast.sd4324530.fastweixin.util.BeanUtil.requireNonNull(user, "user is null");
     ...
     * @return 更新结果
     */
    public QYResultType update(com.fast.sd4324530.fastweixin.company.api.entity.QYUser user){
        com.fast.sd4324530.fastweixin.util.BeanUtil.requireNonNull(user, "user is null");
    ...
    public GetQYUserInfoResponse get(String userId){
        ...
        response = com.fast.sd4324530.fastweixin.util.JSONUtil.toBean(resultJson, GetQYUserInfoResponse.class);
        return response;
    }
     ...
     * @return 部门成员
     */
    public com.fast.sd4324530.fastweixin.company.api.response.GetQYUserInfo4DepartmentResponse simpleList(Integer departmentId, boolean isLoop, Integer status){
        com.fast.sd4324530.fastweixin.company.api.response.GetQYUserInfo4DepartmentResponse response;
        ...
        BaseResponse r = executeGet(url);
        String resultJson = isSuccess(r.getErrcode()) ? r.getErrmsg() : r.toJsonString();
        response = com.fast.sd4324530.fastweixin.util.JSONUtil.toBean(resultJson, com.fast.sd4324530.fastweixin.company.api.response.GetQYUserInfo4DepartmentResponse.class);
        return response;
    }
     ...
     * @return 部门成员详情信息
     */
    public com.fast.sd4324530.fastweixin.company.api.response.GetQYUserInfo4DepartmentResponse getList(Integer departmentId, boolean isLoop, Integer status){
        com.fast.sd4324530.fastweixin.company.api.response.GetQYUserInfo4DepartmentResponse response;
     ...
     * @return 邀请结果
     */
    public com.fast.sd4324530.fastweixin.company.api.response.GetQYUserInviteResponse invite(String userid){
        com.fast.sd4324530.fastweixin.util.BeanUtil.requireNonNull(userid, "userid is null");
        com.fast.sd4324530.fastweixin.company.api.response.GetQYUserInviteResponse response;
        ...
        String resultJson = isSuccess(r.getErrcode()) ? r.getErrmsg() : r.toJsonString();
        response = com.fast.sd4324530.fastweixin.util.JSONUtil.toBean(resultJson, com.fast.sd4324530.fastweixin.company.api.response.GetQYUserInviteResponse.class);
        return response;
    }
     ...
     * @return 用户信息
     */
    public com.fast.sd4324530.fastweixin.company.api.response.GetOauthUserInfoResponse getOauthUserInfo(String code){
        if(com.fast.sd4324530.fastweixin.util.StrUtil.isBlank(code)){
            throw new NullPointerException("code is null");
        }
        com.fast.sd4324530.fastweixin.company.api.response.GetOauthUserInfoResponse response;
        ...
        response = com.fast.sd4324530.fastweixin.util.JSONUtil.toBean(jsonResult, com.fast.sd4324530.fastweixin.company.api.response.GetOauthUserInfoResponse.class);
        return response;
    }
}
