...
import com.fast.sd4324530.fastweixin.api.enums.MediaType;
...
public class QYMediaAPI extends QYBaseAPI {
     ...
     */
    public QYMediaAPI(com.fast.sd4324530.fastweixin.company.api.config.QYAPIConfig config) {
        super(config);
    }
     ...
     * @return 上传结果
     */
    public com.fast.sd4324530.fastweixin.company.api.response.UploadMediaResponse upload(MediaType type, File file){
        if(type == MediaType.NEWS){
            LOG.debug("企业号媒体素材不包含新闻列表");
            return null;
        }
        com.fast.sd4324530.fastweixin.company.api.response.UploadMediaResponse response;
        ...
        response = com.fast.sd4324530.fastweixin.util.JSONUtil.toBean(resultJson, com.fast.sd4324530.fastweixin.company.api.response.UploadMediaResponse.class);
        return response;
    }
     ...
     * @return 下载结果
     */
    public com.fast.sd4324530.fastweixin.company.api.response.DownloadMediaResponse download(String mediaId){
        com.fast.sd4324530.fastweixin.company.api.response.DownloadMediaResponse response = new com.fast.sd4324530.fastweixin.company.api.response.DownloadMediaResponse();
        ...
        try{
            ...
            if(HttpStatus.SC_OK == r.getStatusLine().getStatusCode()){
                ...
                if (null != headers && 0 != headers.length) {
                    ...
                    response = com.fast.sd4324530.fastweixin.util.JSONUtil.toBean(json, com.fast.sd4324530.fastweixin.company.api.response.DownloadMediaResponse.class);
                }
            }
        } catch (Exception e) {
            LOG.error("异常", e);
