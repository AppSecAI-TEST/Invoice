...
public class QYOauthAPI extends QYBaseAPI {
     ...
     */
    public QYOauthAPI(com.fast.sd4324530.fastweixin.company.api.config.QYAPIConfig config) {
        super(config);
    }
    ...
    public String getOauthPageUrl(String redirectUrl, OauthScope scope, String state){
        if(com.fast.sd4324530.fastweixin.util.StrUtil.isBlank(redirectUrl)){
