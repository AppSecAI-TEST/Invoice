...
import com.fast.sd4324530.fastweixin.company.api.config.QYAPIConfig;
import com.fast.sd4324530.fastweixin.company.api.entity.QYAgent;
import com.fast.sd4324530.fastweixin.company.api.enums.QYResultType;
import com.fast.sd4324530.fastweixin.company.api.response.GetQYAgentListResponse;
...
public class QYAgentAPI extends QYBaseAPI {
     ...
     * @return 应用信息
     */
    public com.fast.sd4324530.fastweixin.company.api.response.GetQYAgentInfoResponse getInfo(String agentId){
        BeanUtil.requireNonNull(agentId, "agentId is null");
        com.fast.sd4324530.fastweixin.company.api.response.GetQYAgentInfoResponse response;
        String url = BASE_API_URL + "cgi-bin/agent/get?access_token=#&agentid=" + agentId;
        BaseResponse r = executeGet(url);
        String jsonResult = isSuccess(r.getErrcode()) ? r.getErrmsg() : r.toJsonString();
        response = JSONUtil.toBean(jsonResult, com.fast.sd4324530.fastweixin.company.api.response.GetQYAgentInfoResponse.class);
        return response;
    }
