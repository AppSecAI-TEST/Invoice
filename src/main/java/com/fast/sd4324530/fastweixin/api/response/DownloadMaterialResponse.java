...
public class DownloadMaterialResponse extends BaseResponse {
    ...
    private List<com.fast.sd4324530.fastweixin.message.Article> news;
    ...
    public List<com.fast.sd4324530.fastweixin.message.Article> getNews() {
        return news;
    }

    public void setNews(List<com.fast.sd4324530.fastweixin.message.Article> news) {
        this.news = news;
    }
