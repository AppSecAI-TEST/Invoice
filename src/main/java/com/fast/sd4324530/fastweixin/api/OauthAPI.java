...
import com.fast.sd4324530.fastweixin.api.response.GetUserInfoResponse;
...
public class OauthAPI extends BaseAPI {
    ...
    public OauthAPI(com.fast.sd4324530.fastweixin.api.config.ApiConfig config) {
        super(config);
    }
    ...
    public String getOauthPageUrl(String redirectUrl, OauthScope scope, String state) {
        com.fast.sd4324530.fastweixin.util.BeanUtil.requireNonNull(redirectUrl, "redirectUrl is null");
        com.fast.sd4324530.fastweixin.util.BeanUtil.requireNonNull(scope, "scope is null");
        String userState = com.fast.sd4324530.fastweixin.util.StrUtil.isBlank(state) ? "STATE" : state;
        String url = null;
        try {
    ...
    public OauthGetTokenResponse getToken(String code) {
        com.fast.sd4324530.fastweixin.util.BeanUtil.requireNonNull(code, "code is null");
        ...
        response = com.fast.sd4324530.fastweixin.util.JSONUtil.toBean(resultJson, OauthGetTokenResponse.class);
        return response;
    }
    ...
    public OauthGetTokenResponse refreshToken(String refreshToken) {
        com.fast.sd4324530.fastweixin.util.BeanUtil.requireNonNull(refreshToken, "refreshToken is null");
        OauthGetTokenResponse response = null;
    ...
    public GetUserInfoResponse getUserInfo(String token, String openid) {
        com.fast.sd4324530.fastweixin.util.BeanUtil.requireNonNull(token, "token is null");
        ...
        BaseResponse r = executeGet(url);
        String resultJson = isSuccess(r.getErrcode()) ? r.getErrmsg() : r.toJsonString();
        response = com.fast.sd4324530.fastweixin.util.JSONUtil.toBean(resultJson, GetUserInfoResponse.class);
        return response;
    }
