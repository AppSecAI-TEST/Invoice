...
import com.fast.sd4324530.fastweixin.api.entity.Article;
import com.fast.sd4324530.fastweixin.api.enums.MaterialType;
...
public class MaterialAPI extends BaseAPI {
     ...
     * @return 上传结果
     */
    public com.fast.sd4324530.fastweixin.api.response.UploadMaterialResponse uploadMaterialFile(File file){
     ...
     * @return 上传结果
     */
    public com.fast.sd4324530.fastweixin.api.response.UploadMaterialResponse uploadMaterialFile(File file, String title, String introduction){
        com.fast.sd4324530.fastweixin.api.response.UploadMaterialResponse response;
        String url = "http://api.weixin.qq.com/cgi-bin/material/add_material?access_token=#";
        com.fast.sd4324530.fastweixin.api.response.BaseResponse r;
        ...
        response = JSONUtil.toBean(resultJson, com.fast.sd4324530.fastweixin.api.response.UploadMaterialResponse.class);
        return response;
    }
     ...
     * @return 上传结果
     */
    public com.fast.sd4324530.fastweixin.api.response.UploadMaterialResponse uploadMaterialNews(List<Article> articles){
        com.fast.sd4324530.fastweixin.api.response.UploadMaterialResponse response;
        String url = BASE_API_URL + "cgi-bin/material/add_news?access_token=#";
        final Map<String, Object> params = new HashMap<String, Object>();
        params.put("articles", articles);
        com.fast.sd4324530.fastweixin.api.response.BaseResponse r = executePost(url, JSONUtil.toJson(params));
        String resultJson = isSuccess(r.getErrcode()) ? r.getErrmsg() : r.toJsonString();
        response = JSONUtil.toBean(resultJson, com.fast.sd4324530.fastweixin.api.response.UploadMaterialResponse.class);
        return response;
    }
     ...
     * @return 下载结果
     */
    public com.fast.sd4324530.fastweixin.api.response.DownloadMaterialResponse downloadMaterial(String mediaId, MaterialType type){
        com.fast.sd4324530.fastweixin.api.response.DownloadMaterialResponse response = new com.fast.sd4324530.fastweixin.api.response.DownloadMaterialResponse();
            ...
            if(HttpStatus.SC_OK == httpResponse.getStatusLine().getStatusCode()){
                ...
                switch (type){
                    case NEWS:
                        ...
                        response = JSONUtil.toBean(resultJson, com.fast.sd4324530.fastweixin.api.response.DownloadMaterialResponse.class);
                        LOG.debug("-----------------请求成功-----------------");
                        LOG.debug("响应结果:");
     ...
     * @return 永久素材数量结果
     */
    public com.fast.sd4324530.fastweixin.api.response.GetMaterialTotalCountResponse countMaterial(){
        com.fast.sd4324530.fastweixin.api.response.GetMaterialTotalCountResponse response = null;
        ...
        String resultJson = isSuccess(r.getErrcode()) ? r.getErrmsg() : r.toJsonString();
        response = JSONUtil.toBean(resultJson, com.fast.sd4324530.fastweixin.api.response.GetMaterialTotalCountResponse.class);
        return response;
    }
     ...
     * @return 素材列表结果
     */
    public com.fast.sd4324530.fastweixin.api.response.GetMaterialListResponse batchGetMaterial(MaterialType type, int offset, int count){
        if(offset < 0) offset = 0;
        if(count > 20) count = 20;
        if(count < 1) count = 1;

        com.fast.sd4324530.fastweixin.api.response.GetMaterialListResponse response = null;
        ...
        com.fast.sd4324530.fastweixin.api.response.BaseResponse r = executePost(url, JSONUtil.toJson(params));
        String resultJson = isSuccess(r.getErrcode()) ? r.getErrmsg() : r.toJsonString();
        response = JSONUtil.toBean(resultJson, com.fast.sd4324530.fastweixin.api.response.GetMaterialListResponse.class);
    ...
    public ResultType deleteMaterial(String mediaId) {
        ...
        com.fast.sd4324530.fastweixin.api.response.BaseResponse response = executePost(url, JSONUtil.toJson(param));
        return ResultType.get(response.getErrcode());
    }

    private void downloadVideo(com.fast.sd4324530.fastweixin.api.response.DownloadMaterialResponse response){
     ...
     * @return
     */
    public com.fast.sd4324530.fastweixin.api.response.DownloadMaterialResponse getMaterial(String mediaId) {
		com.fast.sd4324530.fastweixin.api.response.DownloadMaterialResponse materialresponse = null;
        String url = BASE_API_URL + "cgi-bin/material/get_material?access_token=#";
        Map<String, String> param = new HashMap<String, String>();
        param.put("media_id", mediaId);
        com.fast.sd4324530.fastweixin.api.response.BaseResponse r = executePost(url, JSONUtil.toJson(param));
        String resultJson = isSuccess(r.getErrcode()) ? r.getErrmsg() : r.toJsonString();
        materialresponse = JSONUtil.toBean(resultJson, com.fast.sd4324530.fastweixin.api.response.DownloadMaterialResponse.class);
