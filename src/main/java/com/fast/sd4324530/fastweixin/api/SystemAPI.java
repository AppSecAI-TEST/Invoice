...
public class SystemAPI extends BaseAPI {
    ...
    public SystemAPI(com.fast.sd4324530.fastweixin.api.config.ApiConfig config) {
        super(config);
    }
    ...
    public List<String> getCallbackIP() {
        ...
        if (isSuccess(r.getErrcode())) {
            ...
            result = com.fast.sd4324530.fastweixin.util.CollectionUtil.newArrayList(array.size());
    ...
    public String getShortUrl(String longUrl) {
        ...
        if (checkUrl(longUrl)) {
            ...
            if (isSuccess(r.getErrcode())) {
                result = com.fast.sd4324530.fastweixin.util.JSONUtil.toMap(r.getErrmsg()).get("short_url").toString();
            }
        }
        return result;
    }
    ...
    private boolean checkUrl(String url) {
        return com.fast.sd4324530.fastweixin.util.StrUtil.isNotBlank(url) && (url.startsWith("http://") || url.startsWith("https://") || url.startsWith("weixin://wxpay"));
    }
}
