...
public class MenuButton extends BaseModel {
     ...
     * 菜单类别
     */
    private com.fast.sd4324530.fastweixin.api.enums.MenuType type;
    ...
    public com.fast.sd4324530.fastweixin.api.enums.MenuType getType() {
        return type;
    }

    public void setType(com.fast.sd4324530.fastweixin.api.enums.MenuType type) {
        this.type = type;
    }
    ...
    public void setSubButton(List<MenuButton> subButton) {
        if (null == subButton || subButton.size() > 5) {
            throw new com.fast.sd4324530.fastweixin.exception.WeixinException("子菜单最多只有5个");
        }
