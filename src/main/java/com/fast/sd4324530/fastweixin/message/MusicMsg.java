package com.fast.sd4324530.fastweixin.message;

import com.fast.sd4324530.fastweixin.message.util.MessageBuilder;
...
public class MusicMsg extends BaseMsg {
    ...
    public String toXml() {
        ...
        mb.addData("MsgType", com.fast.sd4324530.fastweixin.message.RespType.MUSIC);
        mb.append("<Music>\n");
